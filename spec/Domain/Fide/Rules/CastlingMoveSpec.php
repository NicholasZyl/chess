...
class CastlingMoveSpec extends ObjectBehavior
{
    ...
    function it_disallows_move_if_king_has_already_moved(Board $board, Rules $rules)
    {
        $move = new Move(
            $this->whiteKing,
            CoordinatePair::fromFileAndRank('e', 1),
    ...
    function it_allows_move_if_other_king_has_moved(Board $board, Rules $rules)
    {
        $move = new Move(
            $this->whiteKing,
            CoordinatePair::fromFileAndRank('e', 1),
    ...
    function it_disallows_move_if_rook_was_already_moved(Board $board, Rules $rules)
    {
        $move = new Move(
            $this->blackKing,
            CoordinatePair::fromFileAndRank('e', 8),
    ...
    function it_disallows_move_if_rook_was_captured(Board $board, Rules $rules)
    {
        $move = new Move(
            $this->blackKing,
            CoordinatePair::fromFileAndRank('e', 8),
    ...
    function it_temporarily_prevents_move_if_king_is_attacked(Board $board, Rules $rules)
    {
        $move = new Move(
            $this->whiteKing,
            CoordinatePair::fromFileAndRank('e', 1),
    ...
    function it_temporarily_prevents_move_if_position_king_must_cross_is_attacked(Board $board, Rules $rules)
    {
        $move = new Move(
            $this->whiteKing,
            CoordinatePair::fromFileAndRank('e', 1),
    ...
    function it_temporarily_prevents_move_if_position_king_is_to_occupy_is_attacked(Board $board, Rules $rules)
    {
        $move = new Move(
            $this->whiteKing,
            CoordinatePair::fromFileAndRank('e', 1),
    ...
    function it_temporarily_prevents_move_if_there_is_a_piece_between_king_and_rook(Board $board, Rules $rules)
    {
        $move = new Move(
            $this->whiteKing,
            CoordinatePair::fromFileAndRank('e', 1),
    ...
    function it_plays_rook_move_to_the_square_the_king_has_just_crossed_white_kingside(Board $board, Rules $rules)
    {
    ...
    function it_plays_rook_move_to_the_square_the_king_has_just_crossed_white_queenside(Board $board, Rules $rules)
    {
        $kingWasMoved = new PieceWasMoved(
            new Move(
                $this->whiteKing,
    ...
    function it_plays_rook_move_to_the_square_the_king_has_just_crossed_black_kingside(Board $board, Rules $rules)
    {
        $kingWasMoved = new PieceWasMoved(
            new Move(
                $this->blackKing,
    ...
    function it_plays_rook_move_to_the_square_the_king_has_just_crossed_black_queenside(Board $board, Rules $rules)
    {
        $kingWasMoved = new PieceWasMoved(
            new Move(
                $this->blackKing,
